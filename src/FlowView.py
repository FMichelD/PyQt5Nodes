...
#    
    ...
    #-------------------------------------------------------------------------
    def drawBackground(self, painter: QPainter, rectf: QRectF):
        
        #QGraphicsView.drawBackground(QGraphicsView(), painter, r)
                 
        bBrush = self.backgroundBrush()

        painter.fillRect(rectf,  bBrush)
